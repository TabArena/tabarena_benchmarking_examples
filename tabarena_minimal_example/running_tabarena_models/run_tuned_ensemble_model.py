...
from tabarena_minimal_example.running_tabarena_models.data_utils import (
...
hpo_configs = model_meta.generate_all_configs_lst(
    num_random_configs=n_hyperparameter_configs
)
